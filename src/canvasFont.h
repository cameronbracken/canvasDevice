#ifndef CANVASFONT_H_INCLUDED
#define CANVASFONT_H_INCLUDED
...
// use same definitions as R2SWF package
...
StringMetrics calcFreetypeMetrics(pFontInfo font, const int *char_codes, const int num_chars, const int point_size);
StringMetrics getFreetypeMetrics(SEXP fontObj, const int *char_codes, const int num_chars, const int point_size);
